...
use protocol_registry::{
    ...
    DOMAIN_B1_PROLOGUE, DOMAIN_B1_REKEY_CHAIN, DOMAIN_B1_REKEY_PSK, DOMAIN_B1_STATIC_PSK,
    DOMAIN_B1_TRANSITION, LIMIT_HANDSHAKE_TIMEOUT_MS, LIMIT_MAX_HANDSHAKE_RETRANSMITS,
