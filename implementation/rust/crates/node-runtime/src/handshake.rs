...
use protocol_registry::{
    ...
    BYTES_B1_FINISH_PAYLOAD, BYTES_B1_INITIATE_PAYLOAD, BYTES_B1_INITIATE_PAYLOAD_PSK,
    BYTES_B1_RECORD, BYTES_B1_RECORD_PREFIX, BYTES_B1_RESPOND_PAYLOAD, DOMAIN_B1_EPOCH,
    DOMAIN_B1_EXPORT, DOMAIN_B1_NOISE_PROTOCOL, DOMAIN_B1_NOISE_PROTOCOL_REKEY, DOMAIN_B1_PROLOGUE,
    DOMAIN_B1_REKEY_CHAIN, LIMIT_HANDSHAKE_TIMEOUT_MS, LIMIT_MAX_HANDSHAKE_RETRANSMITS,
...
pub fn profile(suite: [u8; 2]) -> Profile {
    Profile {
        ...
        noise_protocol_rekey: DOMAIN_B1_NOISE_PROTOCOL_REKEY.to_vec(),
        ...
        initiate_payload_bytes: BYTES_B1_INITIATE_PAYLOAD,
