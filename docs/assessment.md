...
| Routing model | Unweighted, undirected graph only | Retain this for Core v0.4 lifecycle experiments, then add weighted, asymmetric, and policy-aware topologies |
