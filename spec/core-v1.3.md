...
- Date: 2026-07-30
- Active profiles: U1, E1, R1, M2, W2, T1, T2, T3
...
Core v1.3 binds T1 recovery to T2 congestion and scheduling. T1 repairs lost fragments without introducing a cross-hop identifier. T2 defines fixed or quantized-adaptive schedule epochs, finite rate negotiation, weighted fair service, and fail-closed overload behavior. Fixed epochs can replace idle slots with encrypted CHAFF; adaptive epochs reveal their public rate class and do not carry an activity-presence privacy claim.
...
Core v1.3 does not itself provide:
...
## 16. T2 conformance additions

A Core v1.3 implementation claiming T2 MUST:
...
## 17. T3 conformance additions

A Core v1.3 implementation or simulator claiming T3 conformance MUST:
