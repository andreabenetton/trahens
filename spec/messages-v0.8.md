# Trahens Core v0.8 messages, M2 encoding, and W2 transport

- Status: Active research design
- Applies to: Core v0.8 with U1, E1, C2, M2, and W2; C1 remains a negative control and reply/signature component set
