...
# Trahens Core v1.6 P1 resource accounting

- Status: Normative limits for the P1 implementation
- Source: `protocol-registry-v1.6.json`
...
The prototype uses bounded synchronous process channels, bounded T1 transmission maps, bounded replay windows, and fixed-size W2 buffers. A production implementation should add allocator-level or process-level hard memory limits; v1.6 CI treats registry ceilings as the protocol-level acceptance boundary.
