...
non-normative future architecture. B1 work is not part of the v1.6 acceptance
gate.
...
- separately started processes interoperate using the active v1.6 specification;
