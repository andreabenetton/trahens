...
46. Core v0.5 with E1 claims deterministic bounded lifecycle behavior under the modeled events; it does not claim global timing resistance or active-tagging resistance.
