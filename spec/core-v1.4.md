...
Core v1.4 does not itself provide:
...
A Core v1.4 implementation claiming T2 MUST:
...
A Core v1.4 implementation or simulator claiming T3 conformance MUST:
...
A Core v1.4 implementation or simulator claiming T4 conformance MUST:
