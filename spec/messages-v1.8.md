...
The stable IDs are generated in `protocol-registry-v1.8.md`. All messages use suite R1 `0x0101` in the mandatory P1 flow; on the experimental C1 profile they use `0x0003`, since the envelope names the suite whose eligibility field it carries.
