...
- [`core-v1.3.md`](core-v1.3.md) - bounded gateway discovery, R1 redemption, M2/W2 framing, T1 recovery, T2 congestion/scheduling, and READY-gated route establishment.
...
- [`transport-profile-t3.md`](transport-profile-t3.md) - equal-budget multi-link route classification, correlated cross traffic, transition-phase measurement, and active probing.
...
- [`messages-v1.3.md`](messages-v1.3.md) - routed operation roles and T1/T2 adjacent-link frame semantics.
- [`state-machines-v1.3.md`](state-machines-v1.3.md) - route, recovery, ACK, timeout, queue, negotiation, and schedule state machines.
- [`invariants-v1.3.md`](invariants-v1.3.md) - route, privacy, encoding, recovery, scheduling, fairness, overload, and failure invariants.
- [`resource-accounting-v1.3.md`](resource-accounting-v1.3.md) - finite route, reassembly, recovery, queue, rate, schedule-control, and CHAFF budgets.

Core v1.3 combines U1, E1, R1, M2, W2, T1, T2, and the T3 analysis profile. Endpoint capability material remains absent from forward discovery. Recovery identifiers and schedule negotiations terminate at every adjacent relay. Each retry uses a fresh public sequence, padding, authentication tag, and ciphertext.
...
- [`t3-test-vectors.json`](t3-test-vectors.json) - deterministic equal-budget public traces, transition phases, and classifier features.
