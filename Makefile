...
registry:
	python tools/generate_protocol_registry.py --python-output simulator/trahens_spec/generated.py --rust-output implementation/rust/crates/protocol-registry/src/generated.rs --markdown-output spec/protocol-registry-v1.6.md
